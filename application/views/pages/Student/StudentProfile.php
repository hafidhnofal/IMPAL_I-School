             ...
             <tr>
                 <th rowspan="2" width="250px" >
                   <form>
                     ...
                     <a href="<?php echo base_url();?>student/view_profile" style=" background:blue">Profile</a>

                 <th colspan="2" width="10000px" height="650px" >
                   <h2> NIS           : <?php echo $user['nis'];?> </h2>
                   <h2> Full Name     : <?php echo $user['name'];?></h2>
                   <h2> Class         : Student Class</h2>
                   <h2> Birthday      : <?php echo $user['birthdate'];?></h2>
