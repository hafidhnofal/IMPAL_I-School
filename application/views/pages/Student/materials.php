...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
            ...
            <li class="active"><a href="<?php echo base_url();?>student/materials"><em class="fa fa-list-alt">&nbsp;</em> Materials</a></li>
							...
							<div class="col-xs-12">
								<div class="row">
									<div class="col-xs-2 col-md-2 date">
										<div class="large"><img src="http://placehold.it/50/30a5ff/fff" class="" alt=""></div>
									</div>
									<div class="col-xs-10 col-md-10">
										<h4 style="font-weight: bold;"><?php echo $data['subjectname']; ?> - <?php echo $data['materials_name']; ?></h4>
										<p><?php echo $data['ket_materials']; ?></p>
										<a href="<?php echo base_url(); ?>student/materials_show/<?= $data['id'] ?>"><button class="btn btn-info">Readmore...</button></a>
									</div>
