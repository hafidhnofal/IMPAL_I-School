...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="<?php echo base_url();?>student/profile"><em class="fa fa-pencil-square-o">&nbsp;</em> Profile</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="hero-info">
                                                ...
                                                <h2><?php echo $student['nis'];?></h2>
                                            </div>
                                            <div class="hero-info">
                                                <h3 style="margin-bottom:12px;">Information :</h3>
                                                <ul>
                                                    <li><span>Class</span><?php echo $student['classnumber'];?></li>
                                                    <li><span>Date of Birth</span><?php echo $student['birthdate'];?></li>
                                                    <li><span>Your Age</span><?php echo date_diff(date_create($student['birthdate']),date_create('today'))->y; ?></li>
                                                    <li><span>Gender</span><?php if($student['gender']=='l'){
                                                            echo "Male";
                                                        }else{
                                                            echo "Female";
                                                        }; ?></li>
                                                    <li><span>Phone </span><?php echo $student['phone'];?></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
