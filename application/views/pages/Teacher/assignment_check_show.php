...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="panel panel-default">
                    ...
                    <a href="<?php echo base_url(); ?>teacher/assignment_check"><button class="btn btn-Link"><em class="fa fa-arrow-left">&nbsp;</em>Back</button></a>
                    Assignment Show</div>
					<div class="panel-body">
							<form action="<?php echo base_url(); ?>teacher/assignment_check_open_mark/<?= $ids ?>" method="POST">
                            <div class="col-md-12">
                            
                            
                            
                                    <div class="form-group col-md-3">
										<label class="col-md-3 control-label" for="name">Point</label>
										<div class="col-md-9">
											<input id="subject" name="grade" type="text" placeholder="Subject" class="form-control">
										</div>
									</div>							
									<!-- Form actions -->
									<div class="form-group  col-md-3">
										<div class="col-md-12 widget-right">
											<button type="submit" class="btn btn-default btn-md">Mark</button>
										</div>
									</div>
                                    </div>
                            </form>
								...
								<div class="form-group">
									...
									<div class="">
                                    <img src="<?php echo base_url();?>img/assignment/<?php echo $ass['image']; ?>" alt="">
									</div>
								</div>
					</div>
				</div>
