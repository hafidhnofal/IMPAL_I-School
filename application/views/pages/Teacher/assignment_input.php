...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="panel panel-default">
					<div class="panel-heading">Add Assignment, for class : <?php echo $teacher['classnumber'];?></div>
					<div class="panel-body">
							<form enctype="multipart/form-data" class="form col-md-6" action="<?php echo base_url(); ?>teacher/assignment_input_action/<?=$teacher['classid'] ?>/<?=$teacher['nip'] ?>" method="post">
                            <!-- Name input-->
								<div class="form-group">
