...
<head>
	...
	<title>Teacher - Add Materials</title>
		...
		<ul class="nav menu">
			...
			<li><a href="<?php echo base_url();?>teacher/attendance"><em class="fa fa-list-alt">&nbsp;</em> Attendance</a></li>
      		...
      		<li class="parent active "><a data-toggle="collapse" href="#sub-item-1">
				<em class="fa fa-calendar">&nbsp;</em> Materials - Input<span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Materials - Add</li>
			</ol>
		</div><!--/.row-->
        ...
        <div class="panel panel-default">
					<div class="panel-heading">Add Materials, for class : <?php echo $teacher['classnumber'];?></div>
					<div class="panel-body">
							<form enctype="multipart/form-data" class="form col-md-6" action="<?php echo base_url(); ?>teacher/materials_input_action/<?=$teacher['classid'] ?>" method="post">
                            <!-- Name input-->
								<div class="form-group">
                                    ...
                                    <select name="sub" id="" class="form-control" >
                                        <?php foreach($sub as $each){ ?>
                                            <option value="<?php echo $each['subjectid']; ?>"><?php echo $each['subjectid']; ?> - <?php echo $each['subjectname']; ?></option>';
                                        <?php }?>
                                        </select>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="">
                                        <input id="" name="title" type="text" placeholder=". . ." class="form-control">
									</div>
								</div>
