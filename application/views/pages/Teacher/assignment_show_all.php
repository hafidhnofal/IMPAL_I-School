                        ...
                        <?php foreach ($ass as $data): ?>
							<li>
								...
								<div class="timeline-panel">
									...
									<a href="<?php echo base_url(); ?>teacher/assignment_edit/<?= $data['assignmentid'] ?>"><button class="btn btn-success">Edit</button></a>
									<a href="<?php echo base_url(); ?>teacher/assignment_del/<?= $data['assignmentid'] ?>"><button class="btn btn-danger">Delete</button></a>
								</div>
							</li>
							<?php endforeach; ?>
						</ul>
