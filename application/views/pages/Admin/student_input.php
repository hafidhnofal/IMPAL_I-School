...
<head>
	...
	<title>Admin - Input Student</title>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent active"><a data-toggle="collapse" href="#sub-item-2">
				<em class="fa fa-book">&nbsp;</em> Student Data - Input<span data-toggle="collapse" href="#sub-item-2" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
		...
		<?php }?>
            <div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="panel-body">
							<form class="form-horizontal" action="<?php echo site_url().'/admin/input_student';?>" method="post">
								<fieldset>
									<!-- Name input-->
									<div class="form-group">
										<label class="col-md-2 control-label" for="name">Nis</label>
										<div class="col-md-8">
											<input id="subject" name="nis" type="number" placeholder="nis.." class="form-control">
										</div>
									</div>	
                                    <div class="form-group">
									...
									<div class="form-group">
										<div class="col-md-9 widget-right">
											<button type="submit" class="btn btn-info btn-md pull-right">Add Student</button>
										</div>
									</div>
								</fieldset>
							</form>
