...
<head>
	...
	<title>Admin - Input Teacher</title>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-3">
				<em class="fa fa-book">&nbsp;</em> Teacher Data - Input<span data-toggle="collapse" href="#sub-item-3" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Teacher Data - Input Teacher</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Input Teacher</h1>
			</div>
		</div><!--/.row-->
		...
		<?php }?>
            <div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="panel-body">
							<form class="form-horizontal" action="<?php echo site_url().'/admin/input_teacher';?>" method="post">
								<fieldset>
									<!-- Name input-->
									<div class="form-group">
										<label class="col-md-2 control-label" for="name">Nip</label>
										<div class="col-md-8">
											<input id="subject" name="nip" type="number" placeholder="nip.." class="form-control">
										</div>
									</div>	
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
										<label class="col-md-2 control-label" for="name">Teacher for Class</label>
										<div class="col-md-8">
                                        <select class="form-control-sm" name="class">
                                            <?php 
									...
									<div class="form-group">
										<div class="col-md-9 widget-right">
											<button type="submit" class="btn btn-info btn-md pull-right">Add Teacher</button>
										</div>
									</div>
								</fieldset>
							</form>
